...
struct SingleCourse: View {
    ...
    let saveHandler: (_ name: String, _ oralWeight: Float, _ ageGroup: AgeGroup) -> ()
    
    
    init(viewTitle: String, courseName: String = "", courseAgeGroup: AgeGroup = .lower, courseOralWeight: Float = 50, saveHandler : @escaping (_ name: String, _ oralWeight: Float, _ ageGroup: AgeGroup) -> ()) {
    ...
    func saveButtonPressed() {
        saveHandler(courseName, selectedWeight, selectedAgeGroup)
