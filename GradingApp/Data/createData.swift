...
func CreateStudents(csvData: String) -> [Student]{
...
var studentsMathe7F = CreateStudents(csvData: csvMathe7F)
var studentsMathe6C = CreateStudents(csvData: csvMathe6C)
var studentsMathe10FLS = CreateStudents(csvData: csvMathe10FLS)


let courses = [Course(name: "Mathe 6C", students: studentsMathe6C), Course(name: "Mathe 7F", students: studentsMathe7F), Course(name: "Mathe 10FLS",students: studentsMathe10FLS)]
